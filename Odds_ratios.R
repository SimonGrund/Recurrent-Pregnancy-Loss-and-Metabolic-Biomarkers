...
ggplot(out2, aes(x = name, y = value))+
  ...
  ggtitle("All cases, unadjusted for baseline characteristics")

ggsave("../Results/Supp Figures/Supp Figure 3//Odds_ratio_biomarkers_above_treshhold.pdf",
       width = 5, height = 4)
...
write.table(out3, "../Results/Tables/TMP/orAll_un.tsv", sep = "\t", col.names = T, row.names = F)
